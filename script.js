// Data Default (2 HP & 1 Laptop) dengan Video Ringan Cepat Diputar
...
// Inisialisasi State dengan Pengaman jika LocalStorage Kosong
...
// Fitur Onboarding & Login Admin/User
function checkOnboarding() {
    ...
    if (!state.user) {
        ...
        // Login Admin khusus Username: "meila"
...
// Fitur Tambah & Edit Produk (CRUD Admin)
...
// Render Katalog Produk di Halaman Utama
function renderProducts() {
    ...
    state.products.forEach(p => {
        // Pengoptimalan Video Cepat Diputar (preload="none" & playsinline)
        const videoHtml = p.video ? `
            <video class="product-video" controls muted playsinline preload="none" poster="${p.image}" style="width:100%; max-height:140px; border-radius:6px; margin-top:6px; background:#000;">
